...
@section('content')
    <div class="p-6 space-y-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md">
            <h3 class="text-xl font-bold text-blue-700 mb-4">Revisi Dokumen QMS</h3>
    ...
    <script>
        ...
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: @json($chartLabels), // judul dokumen QMS
                datasets: [{
                    label: 'Jumlah Revisi',
                    data: @json($chartData), // jumlah revisi per dokumen
