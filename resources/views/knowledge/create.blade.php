...
@section('page-title', 'Tambah Knowledge')
    ...
    <div class="max-w-3xl mx-auto py-8 px-4 sm:px-6">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-500 text-xs mt-1">
                Buat dan publikasikan dokumentasi atau basis pengetahuan baru ke dalam sistem.
            </p>
        </div>
            ...
            <form action="{{ route('knowledge.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="description" rows="5" required
                        class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400
                        focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all bg-gray-50/30"
                        placeholder="Tuliskan rangkuman isi materi dokumen disini...">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="space-y-2 pt-2 border-t border-gray-100">
                    <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider">Unggah Lampiran</label>
                    ...
                    <p class="text-[11px] text-gray-400">Wajib mengunggah berkas dokumen pendukung dengan format PDF.</p>
                </div>
